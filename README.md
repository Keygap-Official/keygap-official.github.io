...
<head>
    ...
    <title>Keygap Glow | Luxury Skincare & Beauty Finds</title>
    ...
    <style>
        ...
        .overlay { position: absolute; bottom: 0; left: 0; right: 0; padding: 30px; background: linear-gradient(to top, rgba(0,0,0,0.8), transparent); color: #fff; }

        footer { padding: 60px; background: var(--soft-gray); text-align: center; font-size: 0.8rem; color: #888; border-top: 1px solid #eee; }
    </style>
</head>
<body>
    ...
    <header>
        <h1>Keygap Glow</h1>
        <div class="tagline">The Art of Skin Perfection</div>
    </header>
    ...
    <div class="showcase">
        <div class="image-card">
            <img src="main_photo.jpg" alt="Keygap Glow 1">
            <div class="overlay">The Morning Ritual</div>
        </div>
        <div class="image-card">
            <img src="milk_bath.jpg" alt="Keygap Glow 2">
            <div class="overlay">Milk Bath Therapy</div>
        </div>
        <div class="image-card">
            <img src="silk_legs.jpg" alt="Keygap Glow 3">
            <div class="overlay">Silk Legs Secret</div>
        </div>
    </div>
